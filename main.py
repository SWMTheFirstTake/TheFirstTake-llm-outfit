    ...
    def __init__(self):
        ...
        self.expert_profiles = {
            FashionExpertType.STYLE_ANALYST: {
                ...
                "prompt_template": "사용자에게 이전 템플릿의 추천이 어울릴지에 대한 생각을 매우 간단하게 회의적 80% 긍정적 20%의 느낌으로 1줄과, 체형분석과 핏감을 중심으로 고려하고 있음을 알려주고 어울리는 실루엣과 스타일을 한 줄 이내로 추천해주세요. 성별은 모르겠으면 물어보거나, 20대 남자로 가정하세요."
            },
            FashionExpertType.TREND_EXPERT: {
                "role": "패션 트렌드 전문가",
