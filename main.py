    ...
    def __init__(self):
        ...
        self.expert_profiles = {
            ...
            FashionExpertType.COLOR_EXPERT: {
                ...
                "prompt_template": "사용자에게 이전 템플릿의 추천이 어울릴지에 대한 생각을 매우 간단한 느낌으로 1줄과, 퍼스널 컬러와 색상 조합을 고려하고 있음을 알려주고 어울리는 색상의 옷을 한 줄 이내로 추천해주세요. 성별과 피부톤을 사용자가 알려주지 않은 경우에는 일반적인 20대 남자로 가정하고, 사용자에게 
            },
            # FashionExpertType.TPO_EXPERT: {
            #     "role": "TPO 상황별 패션 전문가",
