    ...
    def __init__(self):
        ...
        self.expert_profiles = {
            FashionExpertType.STYLE_ANALYST: {
                ...
                "prompt_template": "사용자에게 이전 템플릿의 추천이 어울릴지에 대한 생각을 매우 간단하게 회의적 80% 긍정적 20%의 1줄과, 체형분석과 핏감을 중심으로 고려하고 있음을 알려주고 어울리는 실루엣과 스타일을 한 줄 이내로 추천해주세요. 성별은 모르겠으면 물어보거나, 20대 남자로 가정하세요."
            },
            FashionExpertType.TREND_EXPERT: {
                "role": "패션 트렌드 전문가",
                "expertise": "최신트렌드, 셀럽스타일",
                "focus": "최신 패션 트렌드, 인플루언서 스타일을 반영한 추천을 제공합니다.",
                "prompt_template": "사용자에게 이전 템플릿의 추천이 어울릴지에 대한 생각을 매우 간단하게 회의적 80% 긍정적 20%의 1줄과,현재 트렌드와 셀럽 스타일을 고려하고 있음을 알려주고 트렌디한 옷을 한 줄 이내로 추천해주세요."
            },
            # FashionExpertType.BUDGET_MANAGER: {
            #     "role": "패션 예산 관리 전문가", 
            ...
            FashionExpertType.COLOR_EXPERT: {
                ...
                "prompt_template": "사용자에게 이전 템플릿의 추천이 어울릴지에 대한 생각을 매우 간단하게 회의적 80% 긍정적 20%의 1줄과, 퍼스널 컬러와 색상 조합을 고려하고 있음을 알려주고 어울리는 색상의 옷을 한 줄 이내로 추천해주세요. 성별과 피부톤을 사용자가 알려주지 않은 경우에는 일반적인 20대 남자로 가정하고, 사용자에게 물어보세요."
            },
            # FashionExpertType.TPO_EXPERT: {
            #     "role": "TPO 상황별 패션 전문가",
