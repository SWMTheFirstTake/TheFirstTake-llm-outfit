    ...
    async def _generate_json_based_response(self, user_input: str, expert_type: FashionExpertType, json_data: dict = None) -> str:
        ...
        expert_responses = {
            ...
            FashionExpertType.TREND_EXPERT: [
                ...
                f"{top_info.get('fit', '')} {top_info.get('color', '')} {top_info.get('item', '')} + {bottom_info.get('fit', '')} {bottom_info.get('color', '')} {bottom_info.get('item', '')} 조합 인스타에서 자주 보여. {styling_info.get('fit_details', '')} 트렌디해.",
                f"{top_info.get('fit', '')} {top_info.get('color', '')} {top_info.get('item', '')} + {bottom_info.get('fit', '')} {bottom_info.get('color', '')} {bottom_info.get('item', '')} 조합 요즘 많이 입어. {top_info.get('color', '')} 컬러 이번 시즌에 괜찮아.",
                ...
                f"{top_info.get('fit', '')} {top_info.get('color', '')} {top_info.get('item', '')} + {bottom_info.get('fit', '')} {bottom_info.get('color', '')} {bottom_info.get('item', '')} 조합 요즘 트렌드야. {top_info.get('material', '')} 소재도 많이입어."
            ],
            FashionExpertType.COLOR_EXPERT: [
        ...
        if shoes_info.get("item"):
            ...
            shoe_expressions = {
                ...
                FashionExpertType.TREND_EXPERT: [
                    f" {shoe_color} {shoe_item}도 요즘 많이 신어.",
