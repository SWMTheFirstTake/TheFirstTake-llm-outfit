    ...
    def __init__(self, api_key: str):
        ...
        self.expert_profiles = {
            FashionExpertType.STYLE_ANALYST: {
                ...
                # "prompt_template": "앞에 나온 의견도 참고하긴 하되, 네가 생각하는 체형과 핏에 어울리는 스타일을 솔직하게 하나만 추천해줘! 너무 길게 말 필요 없고, 한두 문장 정도로 딱 하나의 스타일 이름만 알려주면 돼. 예를 들면 '미니멀 캐주얼', '스트릿 패션' 이런 식으로 말해줘. 설명이나 여러 개 추천은 하지 말고, 스타일 이름만 간단하게 알려줘!"
            },
            FashionExpertType.TREND_EXPERT: {
                ...
                # "prompt_template": "앞에 나온 의견도 참고하긴 하되, 요즘 트렌드에 맞는 스타일을 네가 생각하는 대로 하나만 추천해줘! 길게 설명하지 말고, 한두 문장으로 스타일 이름만 딱 알려주면 돼. 예를 들면 '미니멀 캐주얼', '스트릿 패션' 이런 식으로. 여러 개 말고 하나만, 설명도 생략해줘!"
            },
            ...
            FashionExpertType.COLOR_EXPERT: {
                ...
                # "prompt_template": "앞에 나온 의견도 참고하긴 하되, 컬러 조합이나 퍼스널 컬러에 어울리는 스타일을 네가 생각하는 대로 하나만 추천해줘! 길게 말 필요 없고, 한두 문장으로 스타일 이름만 딱 알려주면 돼. 예를 들면 '미니멀 캐주얼', '스트릿 패션' 이런 식으로. 설명이나 여러 개 추천은 하지 말고, 스타일 이름만 간단하게 알려줘!"
            },
            ...
            FashionExpertType.FITTING_COORDINATOR: {
                ...
                # "prompt_template": "앞에 나온 여러 의견을 참고해서, 네가 생각할 때 제일 잘 어울릴 것 같은 스타일을 하나만 추천해줘! 길게 설명하지 말고, 한두 문장으로 스타일 이름만 딱 알려주면 돼. 예를 들면 '미니멀 캐주얼', '스트릿 패션' 이런 식으로. 여러 개 말고 하나만, 설명도 생략해줘!"
            }
        }
...
6. 최대한 간결하게 1줄 ~ 2줄 이내의 핵심만 전달하세요
7. 하나의 패션 스타일만 추천하세요.
