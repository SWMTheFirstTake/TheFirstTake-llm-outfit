...

{
  ...
  "shoes": {
    ...
    "color": "간소화된 색상명 (예: 화이트, 블랙, 브라운, 그레이, 블루, 레드, 브라운, 네이비)",
  ...
  "styling_methods": {
    ...
    "styling_points": "스타일링 포인트 (롤업, 버튼 상태, 주머니 활용, 벨트 착용, 액세서리 활용 등)",
    ...
    "pocket_usage": "주머니 활용 (주머니 사용 여부, 주머니 스타일링, 주머니에 손 넣기 등)",
